...
namespace WebJobPortal.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        {
        //  UserIndexViewModel um = new UserIndexViewModel();
        //  var userId = User.Identity.GetUserId();
        // 
        //  um.User  = new RegisterViewModel() { ID = User.Identity. }
        ...
        public ActionResult SetUserProperties(SetPropertiesViewModel model)
        {
            ...
            var result = _proxy.CreateUser(UserMapping.Map_SetPropertiesViewModel_To_User(model));
            if (result)
            {
