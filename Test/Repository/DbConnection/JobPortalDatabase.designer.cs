...
namespace Repository.DbConnection
{
    ...
    partial void InsertAvailabilityState(AvailabilityState instance);
    partial void UpdateAvailabilityState(AvailabilityState instance);
    partial void DeleteAvailabilityState(AvailabilityState instance);
    ...
    partial void DeleteAspNetUsers(AspNetUsers instance);
		...
		public System.Data.Linq.Table<AvailabilityState> AvailabilityStates
		{
			get
			{
				return this.GetTable<AvailabilityState>();
			}
		}
			...
			set
			{
							...
							|| (this._AspNetUsers.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.AspNetUserClaim.Remove(this);
					}
					this._AspNetUsers.Entity = value;
					if ((value != null))
					{
						value.AspNetUserClaim.Add(this);
		...
		public AspNetUsers AspNetUsers
		{
			...
			set
			{
							...
							|| (this._AspNetUsers.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._AspNetUsers.Entity = null;
						previousValue.AspNetUserLogin.Remove(this);
					}
					this._AspNetUsers.Entity = value;
					if ((value != null))
					{
						value.AspNetUserLogin.Add(this);
						this._UserId = value.Id;
					}
					else
					{
		...
		public AspNetUsers AspNetUsers
		{
			...
			set
			{
							...
							|| (this._AspNetUsers.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._AspNetUsers.Entity = null;
						previousValue.AspNetUserRole.Remove(this);
					}
					this._AspNetUsers.Entity = value;
					if ((value != null))
					{
						value.AspNetUserRole.Add(this);
						this._UserId = value.Id;
					}
					else
					{
	...
	public partial class ServiceOffer : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private int _ServiceAvailability;
		...
		private EntityRef<AvailabilityState> _AvailabilityState;
    ...
    partial void OnServiceAvailabilityChanging(int value);
    partial void OnServiceAvailabilityChanged();
    #endregion
		...
		public ServiceOffer()
		{
			...
			this._AvailabilityState = default(EntityRef<AvailabilityState>);
			this._AspNetUsers = default(EntityRef<AspNetUsers>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ServiceAvailability", DbType="Int NOT NULL")]
		public int ServiceAvailability
		{
			get
			{
				return this._ServiceAvailability;
			}
			set
			{
				if ((this._ServiceAvailability != value))
				{
					if (this._AvailabilityState.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnServiceAvailabilityChanging(value);
					this.SendPropertyChanging();
					this._ServiceAvailability = value;
					this.SendPropertyChanged("ServiceAvailability");
					this.OnServiceAvailabilityChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AvailabilityState_ServiceOffer", Storage="_AvailabilityState", ThisKey="ServiceAvailability", OtherKey="ID", IsForeignKey=true)]
		public AvailabilityState AvailabilityState
		{
			get
			{
				return this._AvailabilityState.Entity;
			}
			set
			{
				AvailabilityState previousValue = this._AvailabilityState.Entity;
				if (((previousValue != value) 
							|| (this._AvailabilityState.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._AvailabilityState.Entity = null;
						previousValue.ServiceOffers.Remove(this);
					}
					this._AvailabilityState.Entity = value;
					if ((value != null))
					{
						value.ServiceOffers.Add(this);
						this._ServiceAvailability = value.ID;
					}
					else
					{
						this._ServiceAvailability = default(int);
					}
					this.SendPropertyChanged("AvailabilityState");
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.AvailabilityState")]
	public partial class AvailabilityState : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<AspNetUsers> _AspNetUsers;
    ...
    partial void OnStateChanged();
		...
		{
			this._ServiceOffers = new EntitySet<ServiceOffer>(new Action<ServiceOffer>(this.attach_ServiceOffers), new Action<ServiceOffer>(this.detach_ServiceOffers));
			this._AspNetUsers = new EntitySet<AspNetUsers>(new Action<AspNetUsers>(this.attach_AspNetUsers), new Action<AspNetUsers>(this.detach_AspNetUsers));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AvailabilityState_ServiceOffer", Storage="_ServiceOffers", ThisKey="ID", OtherKey="ServiceAvailability")]
		public EntitySet<ServiceOffer> ServiceOffers
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AvailabilityState_AspNetUsers", Storage="_AspNetUsers", ThisKey="ID", OtherKey="AvailabilityState")]
		public EntitySet<AspNetUsers> AspNetUsers
		{
			get
			{
		...
		{
			this.SendPropertyChanging();
			entity.AvailabilityState = this;
		}
		
		private void detach_ServiceOffers(ServiceOffer entity)
		{
			this.SendPropertyChanging();
			entity.AvailabilityState = null;
		}
		
		private void attach_AspNetUsers(AspNetUsers entity)
		{
			this.SendPropertyChanging();
			entity.AvailabilityState1 = this;
		}
		
		private void detach_AspNetUsers(AspNetUsers entity)
		{
			this.SendPropertyChanging();
			entity.AvailabilityState1 = null;
		}
	}
	...
	public partial class AspNetUsers : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<AspNetUserClaim> _AspNetUserClaim;
		
		private EntitySet<AspNetUserLogin> _AspNetUserLogin;
		
		private EntitySet<AspNetUserRole> _AspNetUserRole;
		...
		private EntityRef<AvailabilityState> _AvailabilityState1;
    ...
    partial void OnAvailabilityStateChanging(int value);
    partial void OnAvailabilityStateChanged();
    #endregion
		
		public AspNetUsers()
		{
			this._AspNetUserClaim = new EntitySet<AspNetUserClaim>(new Action<AspNetUserClaim>(this.attach_AspNetUserClaim), new Action<AspNetUserClaim>(this.detach_AspNetUserClaim));
			this._AspNetUserLogin = new EntitySet<AspNetUserLogin>(new Action<AspNetUserLogin>(this.attach_AspNetUserLogin), new Action<AspNetUserLogin>(this.detach_AspNetUserLogin));
			this._AspNetUserRole = new EntitySet<AspNetUserRole>(new Action<AspNetUserRole>(this.attach_AspNetUserRole), new Action<AspNetUserRole>(this.detach_AspNetUserRole));
			...
			this._AvailabilityState1 = default(EntityRef<AvailabilityState>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AvailabilityState", DbType="Int NOT NULL")]
		public int AvailabilityState
		{
			get
			{
			...
			set
			{
				if ((this._AvailabilityState != value))
				{
					if (this._AvailabilityState1.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnAvailabilityStateChanging(value);
					this.SendPropertyChanging();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AspNetUsers_AspNetUserClaim", Storage="_AspNetUserClaim", ThisKey="Id", OtherKey="UserId")]
		public EntitySet<AspNetUserClaim> AspNetUserClaim
		{
			get
			{
				return this._AspNetUserClaim;
			}
			set
			{
				this._AspNetUserClaim.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AspNetUsers_AspNetUserLogin", Storage="_AspNetUserLogin", ThisKey="Id", OtherKey="UserId")]
		public EntitySet<AspNetUserLogin> AspNetUserLogin
		{
			get
			{
				return this._AspNetUserLogin;
			}
			set
			{
				this._AspNetUserLogin.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AspNetUsers_AspNetUserRole", Storage="_AspNetUserRole", ThisKey="Id", OtherKey="UserId")]
		public EntitySet<AspNetUserRole> AspNetUserRole
		{
			get
			{
				return this._AspNetUserRole;
			}
			set
			{
				this._AspNetUserRole.Assign(value);
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AvailabilityState_AspNetUsers", Storage="_AvailabilityState1", ThisKey="AvailabilityState", OtherKey="ID", IsForeignKey=true)]
		public AvailabilityState AvailabilityState1
		{
			get
			{
				return this._AvailabilityState1.Entity;
			}
			set
			{
				AvailabilityState previousValue = this._AvailabilityState1.Entity;
				if (((previousValue != value) 
							|| (this._AvailabilityState1.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._AvailabilityState1.Entity = null;
						previousValue.AspNetUsers.Remove(this);
					}
					this._AvailabilityState1.Entity = value;
					if ((value != null))
					{
						value.AspNetUsers.Add(this);
						this._AvailabilityState = value.ID;
					}
					else
					{
						this._AvailabilityState = default(int);
					}
					this.SendPropertyChanged("AvailabilityState1");
				}
			}
		}
		...
		private void attach_AspNetUserClaim(AspNetUserClaim entity)
		{
			this.SendPropertyChanging();
			entity.AspNetUsers = this;
		}
		
		private void detach_AspNetUserClaim(AspNetUserClaim entity)
		{
			this.SendPropertyChanging();
			entity.AspNetUsers = null;
		}
		
		private void attach_AspNetUserLogin(AspNetUserLogin entity)
		{
			this.SendPropertyChanging();
			entity.AspNetUsers = this;
		}
		
		private void detach_AspNetUserLogin(AspNetUserLogin entity)
		{
			this.SendPropertyChanging();
			entity.AspNetUsers = null;
		}
		
		private void attach_AspNetUserRole(AspNetUserRole entity)
		{
			this.SendPropertyChanging();
			entity.AspNetUsers = this;
		}
		
		private void detach_AspNetUserRole(AspNetUserRole entity)
		{
			this.SendPropertyChanging();
			entity.AspNetUsers = null;
		}
