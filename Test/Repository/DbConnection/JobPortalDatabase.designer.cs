...
namespace Repository.DbConnection
{
	...
	public partial class Account : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<User> _UserTable;
    ...
    partial void OnLatestActivityChanged();
		...
		public Account()
		{
			...
			this._UserTable = default(EntityRef<User>);
			OnCreated();
		}
		...
		public User User
		{
			...
			set
			{
				User previousValue = this._UserTable.Entity;
				if (((previousValue != value) 
	...
	public partial class AddressTable : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<User> _UserTable;
    ...
    partial void OnRegionChanged();
		...
		public AddressTable()
		{
			this._UserTable = new EntitySet<User>(new Action<User>(this.attach_UserTable), new Action<User>(this.detach_UserTable));
			OnCreated();
		}
		...
		public EntitySet<User> UserTable
		{
			get
			{
		...
		private void attach_UserTable(User entity)
		{
			this.SendPropertyChanging();
			entity.AddressTable = this;
		}
		
		private void detach_UserTable(User entity)
		{
			this.SendPropertyChanging();
